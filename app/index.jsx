    ...
    <SafeAreaView className="bg-primary h-full">
      <ScrollView contentContainerStyle={{ height: "100%" }}>
        <View className="w-full items-center min-h-[85vh] px-4 justify-center">
          ...
          <Image source={images.cards} className="max-w-[480px] w-full h-[300px]" resizeMode='contain' />
          <View className="mt-5 relative">
            <Text className="text-white text-3xl font-bold text-center">Discover Endless Possibilities with {' '}
              <Text className="text-secondary-200">Aora</Text>
            </Text>
            <Image source={images.path} className="absolute w-[130px] h-[12px] -bottom-2 right-20" resizeMode='contain'/>
          </View>
